...
public interface BlogRepository extends JpaRepository<Blog, Long> {
    ...
    java.util.List<Blog> findByBlogType(com.farm.platform.entity.BlogType blogType);

    boolean existsByAuthorFarmerAndBlogType(Farmer authorFarmer, com.farm.platform.entity.BlogType blogType);

    @org.springframework.transaction.annotation.Transactional
    @org.springframework.data.jpa.repository.Modifying(clearAutomatically = true, flushAutomatically = true)
    @Query("UPDATE Blog b SET b.blogType = :target WHERE b.blogType = :source")
    int reassignBlogType(@Param("source") com.farm.platform.entity.BlogType source,
                         @Param("target") com.farm.platform.entity.BlogType target);
}
